...
public final class RSInterface {
	...
	public static void unpack(StreamLoader streamLoader, TextDrawingArea textDrawingAreas[],
		 ...
		 * FileWriter("interface_text.txt")); } catch (IOException e1) {
		 * e1.printStackTrace(); }
		 */
		int i = -1;
		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				...
				/*
				 * try { writer.write(rsInterface.id + "="+rsInterface.message);
				 * writer.newLine(); } catch (IOException e) { e.printStackTrace(); }
				 */
			}
	...
	// tab id, config id, configframe, intarray212,spriteid,prayername
	...
	public static void bank(TextDrawingArea[] TDA) {
		...
		addHoverButton(23004, "Bank/BANK", 1, 16, 16, "Close", 0, 23005, 3);
		addHoveredButton(23005, "Bank/BANK", 2, 16, 16, 23006);
		addHoverButton(23007, "Bank/BANK", 17, 35, 25, "Deposit carried items", 0, 23008, 4);
		addHoveredButton(23008, "Bank/BANK", 18, 35, 25, 23009);
	...
	public static void addPrayer(int i, int configId, int configFrame, int anIntArray212, int spriteID,
			String prayerName) {
	...
	public static void Sidebar0(TextDrawingArea[] tda) {
		...
		Sidebar0d(332, 335, "Accurate", "Rapid", "Longrange", 42, 66, 39, 101, 41, 136, 40, 120, 40, 50, 40, 85, tda);
	...
	public static void Sidebar0b(int id, int id2, String text1, String text2, String text3, String text4, int str1x,
			...
			int img2x, int img2y, int img3x, int img3y, int img4x, int img4y, TextDrawingArea[] tda) // 4button nospec
	{
		RSInterface rsi = addInterface(id); // 2423
		/* addText(ID, "Text", tda, Size, Colour, Centered); */
		addText(id2, "-2", tda, 3, 0xff981f, true); // 2426
	...
	public static void Sidebar0c(int id, int id2, int id3, String text1, String text2, String text3, int str1x,
			...
			int img3x, int img3y, TextDrawingArea[] tda) // 3button spec
	{
		RSInterface rsi = addInterface(id); // 2423
		/* addText(ID, "Text", tda, Size, Colour, Centered); */
		addText(id2, "-2", tda, 3, 0xff981f, true); // 2426
	...
	public static void Sidebar0d(int id, int id2, String text1, String text2, String text3, int str1x, int str1y,
			...
			int img3y, TextDrawingArea[] tda) // 3button nospec (magic intf)
	{
		RSInterface rsi = addInterface(id); // 2423
		/* addText(ID, "Text", tda, Size, Colour, Centered); */
		addText(id2, "-2", tda, 3, 0xff981f, true); // 2426
