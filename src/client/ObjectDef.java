...
public final class ObjectDef {
	...
	public static void findObjectByName(String objectName) {
		int results = 0;
		try {
			System.out.println("searching for objects containing "+objectName);
		for (int o = 0; o < 14973; o++) {
			if (forID(o) != null ) {
				if (forID(o).name != null) {
					if (forID(o).name.contains(objectName) || forID(o).name.equalsIgnoreCase(objectName)) {
						System.out.println("found "+forID(o).name+" at id: "+o);
						results++;
					}
				}
			}
		...
		System.out.println("search finished with "+results+" results");
	}
	...
	public static ObjectDef forID(int i) {
		...
		case 1988:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Repair";
			objectDef.description = "Some rope and wood will be needed here...".getBytes();
			break;
		case 12806:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Repair";
			objectDef.description = "Probably needs a few pieces of limestone...".getBytes();
			break;
		case 10377:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Cook";
			objectDef.description = "Use this to cook food for Hiakai.".getBytes();
			break;
		case 12477:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Pick seaweed";
			objectDef.description = "Fresh seaweed grows here.".getBytes();
			break;
		case 3857:
			objectDef.name = "Buried fishing supplies";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Take from";
			objectDef.description = "A crate of fishing supplies.".getBytes();
			break;
		case 2336:
			objectDef.name = "Hiakai's Stomach";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Feed";
			objectDef.description = "A hole that magically leads to Hiakai's stomach.".getBytes();
			break;
		case 2515:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Take boat";
			objectDef.description = "This boat takes you to the Fishing Frenzy minigame.".getBytes();
			break;
		case 10953:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Retrieve items";
			break;
			case 619:
				objectDef.actions = new String[5];
				objectDef.actions[0] = "Make Marijuana";
				objectDef.actions[1] = "Make Meth";
				break;
			case 618:
				objectDef.actions = new String[5];
				objectDef.actions[0] = "Make Cocaine";
				objectDef.actions[1] = "Make Heroin";
				break;
			case 4927:
				objectDef.actions = new String[5];
				objectDef.actions[0] = "Restore stats";
				objectDef.name = "Purity Crystals";
				objectDef.description = "Use these crystals to restore your stats to their base levels.".getBytes();
				break;
			case 1876:
				objectDef.actions = new String[5];
				objectDef.actions[0] = "Pray-at";
				objectDef.name = "Altar of Terror";
				objectDef.description = "A horrifying shrine to evil.".getBytes();
				break;
			case 2153:
				objectDef.actions = new String[5];
			...
			case 5881:
				objectDef.actions = new String[5];
				objectDef.actions[0] = "Light";
				break;
		case 309:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Take logs";
			break;
		case 362:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Store fish";
			break;
		case 4090:
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Sacrifice logs";
			break;
			default: 
