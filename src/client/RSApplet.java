...
public class RSApplet extends Applet implements Runnable, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, FocusListener, WindowListener {
	...
	public final void mousePressed(MouseEvent mouseevent)
	{
		...
		if (button == 4) { //bottom left side button
	...
	public final void mouseDragged(MouseEvent mouseevent)
	{
		...
		if (cameraButtonPressed) {
			int x = cameraButtonX - i;
			int y = cameraButtonY - j;
			int negY = -y;
			anInt1186 += x * 3;
			anInt1187 += (negY << 1);
			cameraButtonX = i;
	...
	public final void mouseWheelMoved(MouseWheelEvent mouseWheel) {
		int direction = mouseWheel.getWheelRotation();
		if (direction > 0 && cameraZoom < 1601) {
			cameraZoom += 50;
		} else if (cameraZoom > 99){
			cameraZoom -= 50;
		} else {
			mouseWheel.getLocationOnScreen();
		}
	}
